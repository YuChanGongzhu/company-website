    ...
    <div class="container text-center pt-5 mt-3">
      ...
      <div class="row business_item1" style="display: none;">
        ...
        <div class="col-md-6 pt-5 text-left d-flex flex-column justify-content-center">
          ...
          <p style="color: #79808A;">PC application development include Customer Relationship Management Systems、Enterprise Resource Planning Systems、<span style="color: #3860D2;">Data Visualization Tools</span> and <span style="color: #3860D2;">Customized WorkflowManagement Systems</span></p>
          <p style="color: #79808A;">Mobile application development Profcient in using programming languages and frameworks such as Swift, KotlinJava, React Native, and Flutter, we develop high-performanceiOS and Android applications.Our expertise spans e-commerce applications, social media applications, mobile ofhceapplications, health monitoring applications, and <span style="color: #3860D2;">customized enterprise applications</span>, Through intuitive user interface design.innovative interaction experiences,optimized performancetuning,and cross-platform compatibility.</p>
          ...
          <p style="color: #79808A;">HTML CSS JavaScript TypeScript Java(SpringBoot) Python(Django Flask) Node.is React AngularVue.is Content management system,e-commerceplatform, single page application, enterprise portal,<span style="color: #3860D2;"> data visualization platform</span>.</p>
          <p style="color: #79808A;">Through responsive desian.modular architecture,front-endand back-end separation,and high-security assurance.</p>
          <p style="color: #79808A;">Our solutions not only meet the <span style="color: #3860D2;"specifc needs></span> of our clientsbut also enhance <span style="color: #3860D2;">operational effciency</span> and <span style="color: #3860D2;">user satisfaction</span>, helping enterprises achieve <span style="color: #3860D2;">digital</span> and <span style="color: #3860D2;">intelligent management</span>.</p>
        </div>
      </div>
...
export default {
  ...
  mounted() {
    ...
    business_btn1.onclick = function() {
      document.querySelector('.business_item1').style.display = 'flex';
      document.querySelector('.business_item2').style.display = 'none';
      document.querySelector('.business_item3').style.display = 'none';
    }
    business_btn2.onclick = function() {
      document.querySelector('.business_item1').style.display = 'none';
      document.querySelector('.business_item2').style.display = 'flex';
      document.querySelector('.business_item3').style.display = 'none';
    }
    business_btn3.onclick = function() {
      document.querySelector('.business_item1').style.display = 'none';
      document.querySelector('.business_item2').style.display = 'none';
      document.querySelector('.business_item3').style.display = 'flex';
    }
  }
}
</script>
